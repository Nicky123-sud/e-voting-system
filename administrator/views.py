...
@csrf_exempt
@staff_member_required
def print_results_pdf(request):
    title = "E-voting"
    try:
        with open(settings.ELECTION_TITLE_PATH, 'r') as file:
            title = file.read()
    except:
        pass
...
#         return context
#
#     def render_to_pdf(selfself, context):
#         # This is the function that will render the HTML template and generate a pdf.
#         # Load HTML Template
...
#
#         if pisa_status.err:
#             return HttpResponse('We had some errors while generating the PDF.', ststus=500)
#
#         return response
